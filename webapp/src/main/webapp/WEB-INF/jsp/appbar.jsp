...
<div class="appbar container">
    ...
    <div class="appbar_buttons">
        ...
        <button class="uk-button uk-button-text" onclick="location.href='<c:url value="/bookings"/>'">Mis reservas</button>
        <button class="uk-button uk-button-text" onclick="location.href='<c:url value="/myEvents"/>'">Mis eventos</button>
