...
<div class="appbar container">
    <img onclick="location.href='<c:url value="/"/>'" class="logo appbar-logo" src="https://media-public.canva.com/uH36Y/MAELBWuH36Y/1/tl.png" alt="BotPass"/>
    <c:if test="${!isBouncer}">
                ...
                <div class="uk-inline">
                    ...
                    <div uk-dropdown="mode: click; pos: bottom-center">
                        <ul class="uk-nav uk-dropdown-nav">
                            <c:if test="${!isBouncer}">
                                <li><a class="bigger" href="<c:url value="/profile"/>"><spring:message code="appbar.dropdown0"/></a></li>
                                <li><a class="bigger" href="<c:url value="/create-event"/>"><spring:message code="appbar.dropdown5"/></a></li>
                                <li><a class="bigger" href="<c:url value="/bookings"/>"><spring:message code="appbar.dropdown1"/></a></li>
                                <c:if test="${isCreator}">
                                    <li><a class="bigger" href="<c:url value="/my-events"/>"><spring:message code="appbar.dropdown2"/></a></li>
                                    <li><a class="bigger" href="<c:url value="/stats"/>"><spring:message code="appbar.dropdown3"/></a></li>
                                </c:if>
                                <li class="uk-nav-divider"></li>
                            </c:if>
                            <li><a class="bigger" href="<c:url value="/logout"/>"><spring:message code="appbar.dropdown4"/></a></li>
                        </ul>
                    </div>
                </div>
                </c:otherwise>
