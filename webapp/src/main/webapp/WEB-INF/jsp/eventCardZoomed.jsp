...
<div class="card card_zoomed uk-card uk-card-default clickable" onclick="location.href='<c:url value="/events/${event.id}"/>'">
    <div class="uk-card-media-top">
        ...
        <div class="card_img_container card_img_container_zoomed">
            ...
            <c:if test="${event.soldOut}">
                ...
                <img class="soldout_card soldout_card_zoomed" src="<c:url value="/resources/png/sold_out.png"/>" alt="${soldOut}"/>
            </c:if>
        </div>
    </div>
    <div class="uk-card-body">
        ...
        <div class="container card_body">
            ...
            <div class="card_info card_info_zoomed">
                ...
                <img class="icon icon_zoomed" src="<c:url value="/resources/svg/location-pin.svg"/>" alt="${locationAlt}"/><span><c:out value="${event.location.name}"/></span>
            </div>
            <div class="card_info card_info_zoomed">
                <div>
                    <spring:message code="event.dateAlt" var="dateAlt"/>
                    <img class="icon icon_zoomed" src="<c:url value="/resources/svg/date.svg"/>" alt="${dateAlt}"/><span><c:out value="${event.dateFormatted}"/></span>
                </div>
                <div>
                    <spring:message code="event.timeAlt" var="timeAlt"/>
                    <img class="icon icon_zoomed" src="<c:url value="/resources/svg/time.svg"/>" alt="${timeAlt}"/><span><c:out value="${event.timeFormatted}"/></span>
                </div>
            </div>
        </div>
    </div>
