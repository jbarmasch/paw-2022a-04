...
<body>
    ...
    <div class="only-element">
        <form:form class="horizontal" novalidate="true" modelAttribute="eventForm" action="${postPath}" method="post"
                   id="eventForm" enctype="multipart/form-data">
            <div class="interline">
                <h4 class="title2"><spring:message code="create.event"/></h4>
                <div>
                    <spring:message code="create.name" var="namePlaceholder"/>
                    <form:input placeholder="* ${namePlaceholder}" class="uk-input" type="text" path="name"
                                required="true"/>
            ...
            <div class="interline">
                ...
                <div class="horizontal align-center">
                    <div class="horizontal center">
                        ...
                        <form:label path="hasMinAge" class="sep-left"><spring:message
                                code="create.minAge"/></form:label>
                    </div>

                    <form:select class="uk-select input_select sep-left-l" htmlEscape="true" multiple="false"
                                 path="minAge" id="minAgeInput" disabled="true">
