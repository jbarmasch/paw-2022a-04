        ...
        <div class="vertical tickets sep-top-xl">
            <table class="stats-table tickets-table">
                ...
                <tr>
                    ...
                    <td class="table-number"><fmt:formatNumber type="number" maxFractionDigits="2"
                                                               value="${stats.attendance * 100}"/>%
                    </td>
                </tr>
                <tr>
                    <td><spring:message code="stats.popularEvent"/></td>
                    <td class="table-number"><a
                            href="<c:url value="/events/${stats.popularEvent.id}"/>">${stats.popularEvent.name}</a></td>
                </tr>
                <tr>
            ...
            <div class="tickets container vertical">
                <table class="stats-table tickets-table">
                    ...
                    <tr>
                        ...
                        <td class="table-number"><fmt:formatNumber type="number" maxFractionDigits="2"
                                                                   value="${eventStats.saleRatio * 100}"/>%
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><spring:message code="stats.attendanceRatio"/></td>
                        <td class="table-number"><fmt:formatNumber type="number" maxFractionDigits="2"
                                                                   value="${eventStats.attendance * 100}"/>%
                        </td>
                    </tr>
                    <tr>
